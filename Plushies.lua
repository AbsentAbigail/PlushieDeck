...
--- MOD_DESCRIPTION: Player Deck plushie reskin
--- LOADER_VERSION_GEQ: 1.0.0
--- VERSION: 1.0.0
--- BADGE_COLOR: FC03DF

local atlas_key = 'aap_atlas' -- Format: PREFIX_KEY
-- See end of file for notes
local atlas_path = 'Plushies_lc.png' -- Filename for the image in the asset folder
local atlas_path_hc = 'Plushies_hc.png' -- Filename for the high-contrast version of the texture, if existing

local suits = {'hearts', 'clubs', 'diamonds', 'spades'} -- Which suits to replace
local ranks = {'Jack', 'Queen', "King", "Ace"} -- Which ranks to replace

local description = 'Plushies to lighten up your deck' -- English-language description, also used as default
